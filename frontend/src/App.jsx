    ...
    <BrowserRouter>
      <div style={{ minHeight: "100vh", background: "#0f0f18", color: "#fff", fontFamily: "system-ui, sans-serif" }}>
        ...
        <Routes>
          <Route
            path="/"
            element={<ProjectsList account={account} contract={contract} isCorrectNetwork={isCorrectNetwork} />}
          />
          <Route
            path="/submit"
            element={<SubmitProject account={account} contract={contract} isCorrectNetwork={isCorrectNetwork} />}
          />
        </Routes>
      </div>
    </BrowserRouter>
